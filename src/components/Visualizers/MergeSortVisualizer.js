...
import './MergeSortVisualizer.css';  // Import the CSS file
...
const MergeSortVisualizer = () => {
  ...
  useEffect(() => {
    ...
    document.body.classList.add('merge-sort-visualizer-page');

    // Cleanup: Remove the class when the component unmounts
    return () => {
      document.body.classList.remove('merge-sort-visualizer-page');
    };
  }, []);
  ...
  return (
    <div className="mergeSortVisualizerWrapper">
      <div className="sideNavbar">
        ...
        <label className="sliderLabel">
          ...
          <input
            ...
            max="200"
            value={arrSize}
            onChange={(e) => setArrSizeHelper(e.target.value)}
          />
        </label>
        <br />
        <label className="sliderLabel">
